...
public class CollectFromSubSetP extends ParallelCommandGroup {
    public CollectFromSubSetP(ElbowArm elbowArm, ExtenderArm extenderArm, ClawUpDown clawUpDown, Claw claw, DoubleSupplier rightTriggerSupplier){
        addCommands(
